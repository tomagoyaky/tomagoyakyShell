...
import com.tomagoyaky.parsedex.struct.MapItem;
import com.tomagoyaky.parsedex.struct.MapList;
...
public class ParseDexUtils {
	...
	public static int stringIdOffset = 0;
	public static int stringIdsSize = 0;
	public static int stringIdsOffset = 0;
	public static int typeIdsSize = 0;
	public static int typeIdsOffset = 0;
	public static int protoIdsSize = 0;
	public static int protoIdsOffset = 0;
	public static int fieldIdsSize = 0;
	public static int fieldIdsOffset = 0;
	public static int methodIdsSize = 0;
	public static int methodIdsOffset = 0;
	public static int classIdsSize = 0;
	public static int classIdsOffset = 0;
	public static int dataIdsSize = 0;
	public static int dataIdsOffset = 0;
	
	public static int mapListOffset = 0;
	...
	public static List<ClassDefItem> classIdsList = new ArrayList<ClassDefItem>();
	
	public static List<ClassDataItem> dataItemList = new ArrayList<ClassDataItem>();
	...
	public static HashMap<String, ClassDefItem> classDataMap = new HashMap<String, ClassDefItem>();
	
	public static HeaderType praseDexHeader(byte[] byteSrc){
	...
	//解析方法的所有参数类型
	public static ProtoIdsItem parseParameterTypeList(byte[] srcByte, int startOff, ProtoIdsItem item){
	...
	public static ClassDataItem parseClassDataItem(byte[] srcByte, int offset){
	...
	public static CodeItem parseCodeItem(byte[] srcByte, int offset){
	...
	public static StringIdsItem parseStringIdsItem(byte[] srcByte){
	...
	public static TypeIdsItem parseTypeIdsItem(byte[] srcByte){
	...
	public static ProtoIdsItem parseProtoIdsItem(byte[] srcByte){
	...
	public static FieldIdsItem parseFieldIdsItem(byte[] srcByte){
	...
	public static MethodIdsItem parseMethodIdsItem(byte[] srcByte){
	...
	public static ClassDefItem parseClassDefItem(byte[] srcByte){
	...
	public static MapItem parseMapItem(byte[] srcByte){
	...
	public static void ParseAll(byte[] srcByte){
